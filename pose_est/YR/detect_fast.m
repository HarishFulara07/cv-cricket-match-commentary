...
% resp_out = '/Pulsar1/users/digvijay.singh/active_learning/dramanan_pose/pose_iterative/20121128-pose-release-ver1.3/code-basic/resp_PIW.mat';
% if ~exist(resp_out)
%     all_resp{1} = resp;
%     save(resp_out,'all_resp');
% else
%     load(resp_out);
%     all_resp{end+1} = resp;
%     save(resp_out,'all_resp');
