function [weights_exemplar] = get_exemplar_weights_half(cache_dir,vid_dir,fr_indx,phase_number,ex_cnsnt_pick_arr) 
...
%load YR-BASE model
load('models/FLIC_final_666666666666666666.mat');
...
%     im_path = sprintf(ims,fr);
    ...
    for i=1:size(det_,1)
        try
            ...
            tic;
            [models,~] = dg_esvm_demo_train_poseparts_fast(curr_path,num2str(cnvrt_26_18(i)),'negpose_data');
            time_taken = toc;
